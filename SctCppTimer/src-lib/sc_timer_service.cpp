 ...
 */
void TimerService::setTimer(std::shared_ptr<TimedInterface >statemachine, sc::eventid event,
 ...
 */
void TimerService::unsetTimer(std::shared_ptr<TimedInterface >statemachine, sc::eventid event)
{
 ...
 */
void TimerService::setRuncycleTimerFor(std::shared_ptr<CycleBasedInterface >statemachine,  sc::time cycle_period)
{
 ...
 */
void TimerService::unsetRuncycleTimerFor(std::shared_ptr<CycleBasedInterface >statemachine)
{
