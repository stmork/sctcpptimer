...
class AbstractTimerStatechart : public sc::timer::TimedInterface, public std::enable_shared_from_this<sc::timer::TimedInterface>, public sc::EventDrivenInterface
{
	public:
		AbstractTimerStatechart() noexcept;
