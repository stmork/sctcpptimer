...
AbstractTimerStatechart* statechart;
...
class StatechartTest : public ::testing::Test{
	protected:
	virtual void SetUp() {
		statechart = new AbstractTimerStatechart();
...
TEST_F(StatechartTest, testFirst) {
	...
	EXPECT_TRUE(statechart->isStateActive(AbstractTimerStatechart::State::main_region_First));
...
TEST_F(StatechartTest, testSecond) {
	...
	EXPECT_TRUE(statechart->isStateActive(AbstractTimerStatechart::State::main_region_Second));
